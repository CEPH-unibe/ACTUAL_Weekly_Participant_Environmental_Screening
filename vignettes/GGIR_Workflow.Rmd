...
library(dplyr); library(ggplot2);library(ggnewscale);library(viridis);library(kableExtra);library(lubridate)
...
- can I create subfolders so that I can build a routine to do the GGIR run collectively for all participants. every RAW file needs to be in their own folder. 